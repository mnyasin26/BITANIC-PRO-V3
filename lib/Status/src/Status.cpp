...
// void Status::setPenjadwalanOn(bool )

void Status::setTipeTerdekatHariIni(String tipe_terdekat_hari_ini)
{
    this->tipe_terdekat_hari_ini = tipe_terdekat_hari_ini;
}

void Status::setWaktuPendajwalanTerdekatHariIni(String waktu_pendajwalan_terdekat_hari_ini)
{
    this->waktu_pendajwalan_terdekat_hari_ini = waktu_pendajwalan_terdekat_hari_ini;
}

String Status::getTipeTerdekatHariIni()
{
    return this->tipe_terdekat_hari_ini;
}

String Status::getWaktuPendajwalanTerdekatHariIni()
{
    return this->waktu_pendajwalan_terdekat_hari_ini;
}

void Status::setIsStatusChanged(bool isChanged)
{
    this->isChanged = isChanged;
}

bool Status::isStatusChanged()
{
...
void Status::setCurrentIndexSetOnTimes(int index)
{
    this->currentIndexSetOnTimes = index;
}

int Status::getCurrentIndexSetOnTimes()
{
    return this->currentIndexSetOnTimes;
}

int Status::getCurrentPekan()
{
    return this->currentPekan;
}

void Status::setCurrentPekan(int pekan)
{
    this->currentPekan = pekan;
}

void Status::setPenjadwalanOn(bool isPenjadwalanOn)
{
    this->isPenjadwalanOn = isPenjadwalanOn;
}

bool Status::getPenjadwalanOn()
{
    return this->isPenjadwalanOn;
}

void Status::setOnTimesStatus(bool condition, int currentLand, String type)
{
...
void Status::updateFromLoadConfig(JsonDocument doc)
{
    this->doc.clear();
...
JsonDocument Status::getStatusJSON()
{
    updateJSON();
    return this->doc;
}

void Status::setFirmwareVersion(String FirmwareVersion)
{
    this->FirmwareVersion = FirmwareVersion;
}

void Status::setActivation(bool Activation)
{
    this->Activation = Activation;
}

void Status::setStatusJSON(JsonDocument doc)
{
    this->doc = doc;
}

void Status::setID(String ID)
{
    this->ID = ID;
}

void Status::setTotalPekan(int totalPekan)
{
    this->totalPekan = totalPekan;
}

void Status::setTotalOutput(int totalOutput)
{
    this->totalOutput = totalOutput;
}

void Status::setTotalInput(int totalInput)
{
    this->totalInput = totalInput;
}

void Status::setTglAkhirPenjadwalan(String tglAkhirPenjadwalan)
{
    this->tglAkhirPenjadwalan = tglAkhirPenjadwalan;
}

void Status::setSisaPekan(int sisaPekan)
{
    this->sisaPekan = sisaPekan;
}

void Status::setMainPump(bool mainPump)
{
    this->isChanged = true;
    this->mainPump = mainPump;
}

void Status::setWaterPump(bool waterPump)
{
    this->isChanged = true;
    this->waterPump = waterPump;
}

void Status::setNutrientPump(bool nutrientPump)
{
    this->isChanged = true;
    this->nutrientPump = nutrientPump;
}

void Status::setLahan1(bool lahan1)
{
    this->isChanged = true;
    this->lahan1 = lahan1;
}

void Status::setLahan2(bool lahan2)
{
    this->isChanged = true;
    this->lahan2 = lahan2;
}

void Status::setLahan3(bool lahan3)
{
    this->isChanged = true;
    this->lahan3 = lahan3;
}

void Status::setLahan4(bool lahan4)
{
    this->isChanged = true;
    this->lahan4 = lahan4;
}

void Status::setDHTLahan1Temp(float dhtLahan1Temp)
{
    this->dhtLahan1Temp = dhtLahan1Temp;
}

void Status::setDHTLahan1Hum(float dhtLahan1Hum)
{
    this->dhtLahan1Hum = dhtLahan1Hum;
}

void Status::setDHTLahan2Temp(float dhtLahan2Temp)
{
    this->dhtLahan2Temp = dhtLahan2Temp;
}

void Status::setDHTLahan2Hum(float dhtLahan2Hum)
{
    this->dhtLahan2Hum = dhtLahan2Hum;
}

void Status::setFlowMeterLahan1Flow(float flowMeterLahan1Flow)
{
    this->flowMeterLahan1_flow = flowMeterLahan1_flow;
}

void Status::setFlowMeterLahan1Volume(float flowMeterLahan1Volume)
{
    this->flowMeterLahan1_volume = flowMeterLahan1Volume;
}

void Status::setFlowMeterLahan2Flow(float flowMeterLahan2Flow)
{
    this->flowMeterLahan2_flow = flowMeterLahan2Flow;
}

void Status::setFlowMeterLahan2Volume(float flowMeterLahan2Volume)
{
    this->flowMeterLahan2_volume = flowMeterLahan2Volume;
}

void Status::setDate(String date)
{
    this->date = date;
}

void Status::setTime(String time)
{
    this->time = time;
}

String Status::getFirmwareVersion()
{
    return this->FirmwareVersion;
}

bool Status::getActivation()
{
...
int Status::getTotalPekan()
{
    return this->totalPekan;
}

int Status::getTotalOutput()
{
    return this->totalOutput;
}

int Status::getTotalInput()
{
    return this->totalInput;
}

String Status::getTglAkhirPenjadwalan()
{
    return this->tglAkhirPenjadwalan;
}

int Status::getSisaPekan()
{
    return this->sisaPekan;
}

bool Status::getMainPump()
{
    return this->mainPump;
}

bool Status::getWaterPump()
{
    return this->waterPump;
}

bool Status::getNutrientPump()
{
    return this->nutrientPump;
}

bool Status::getLahan1()
{
    return this->lahan1;
}

bool Status::getLahan2()
{
    return this->lahan2;
}

bool Status::getLahan3()
{
    return this->lahan3;
}

bool Status::getLahan4()
{
    return this->lahan4;
}

float Status::getDHTLahan1Temp()
{
    return this->dhtLahan1Temp;
}

float Status::getDHTLahan1Hum()
{
    return this->dhtLahan1Hum;
}

float Status::getDHTLahan2Temp()
{
    return this->dhtLahan2Temp;
}

float Status::getDHTLahan2Hum()
{
    return this->dhtLahan2Hum;
}

float Status::getFlowMeterLahan1Flow()
{
    return this->flowMeterLahan1_flow;
}

float Status::getFlowMeterLahan1Volume()
{
    return this->flowMeterLahan1_volume;
}

float Status::getFlowMeterLahan2Flow()
{
    return this->flowMeterLahan2_flow;
}

float Status::getFlowMeterLahan2Volume()
{
